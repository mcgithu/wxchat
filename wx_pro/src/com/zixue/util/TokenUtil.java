...
public class TokenUtil {
    ...
    * @throws
    ...
    public static Map<String, Object> getToken(){
        ...
        ResultSet rs = null;
        String sql ="select * from weixin_token order by create_time desc limit 0,1";
        String access_token="";
    ...
    * @throws
    ...
    public static void saveToken(Token token){
        ...
        try {  
            ...
            //创建预处理器  
            pst = conn.prepareStatement("insert into weinxin_token(access_token,expires_in,create_time)values(?,?,?)");  
