...
public class TokenThread implements Runnable {
    ...
    // 第三方用户唯一凭证
    public static String appid = PropsUtil.getProperty(PropsParam.WEIXIN_APPID);
    // 第三方用户唯一凭证密钥
    public static String appsecret = PropsUtil.getProperty(PropsParam.WEIXIN_APPSECRET);
